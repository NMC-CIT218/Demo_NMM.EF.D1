...
namespace Demo_NMM.EF.Controllers
{
    public class BreweriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Address,City,State")] Brewery brewery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Address,City,State")] Brewery brewery)
        {
            if (ModelState.IsValid)
            {
